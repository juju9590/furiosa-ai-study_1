...
print(test_csv) # [715 rows x 9 columns]  # = shape이 train_csv의 x_train과 같다, 행무시 열우선(행은 데이터 갯수고 열은 특성이 있음)
...
# 3. 컴파일, 훈련
model.compile(loss="mse", optimizer="adam") # RMSE와 유사한 MSE 사용
...
print(submission)
y_submit = model.predict(test_csv) # 최종 weight에 x값인 test_csv 넣은 거
