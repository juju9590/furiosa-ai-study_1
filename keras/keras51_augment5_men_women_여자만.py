...
print(y_train_1d.shape,y_test_1d.shape ) #(21733,) (5434,)
...
print(np.min(randidx),np.max(randidx),) # 0 7589
...
# (array([1.], dtype=float32), array([7591], dtype=int64))
...
##### 전체 모델 저장
path ='./_save/keras49/'
filename = 'keras49_save_model_up.keras'
