...
# model.save(path + 'keras29_1_save_model.keras') # 초기 가중치 저장
model.save_weights(path + 'keras29_5_save_1.weights.h5') # 확장자 .weights.h5
...
model.save_weights(path + 'keras29_5_save_2.weights.h5') # 확장자 .weights.h5
