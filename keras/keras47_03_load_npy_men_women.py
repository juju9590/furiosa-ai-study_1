...
print(x_train.shape, y_train.shape) #(21733, 100, 100, 3) (21733, 2)
print(x_test.shape, y_test.shape) # (5434, 100, 100, 3) (5434, 2)

'''

np_path = './_save/keras44/' # C:\study\_save\keras46_01
...
model.add(Dense(2, activation='sigmoid')) #y.shape =(27167, 2)
...
##### 모델 저장
path ='./_save/keras49/'
filename = 'keras49_save_model_{epoch:04d}-{val_loss:.4f}.keras'
