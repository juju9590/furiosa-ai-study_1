...
dense1 = Dense(30, activation='relu', name='a1')(input1)
drop1 = Dropout(0.3)(dense1)
dense2 = Dense(120, activation='relu', name='a2')(drop1)
drop2 = Dropout(0.5)(dense2)
dense3 = Dense(80, activation='relu', name='a3')(drop2)
dense4 = Dense(40, activation='relu', name='a4')(dense3)
