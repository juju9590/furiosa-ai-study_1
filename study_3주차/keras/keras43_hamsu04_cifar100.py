...
dense11 = Dense(32, activation='relu' )(drop3)
dense12 = Dense(32, activation='relu' )(dense11)

output1 =Dense(100, activation='softmax')(dense12)  # 출력층 (모델의 끝)
