...
### 데이터 저장, 
np_path = '.d/_data/kaggle_cat_dog_npy/'
np.save(np_path + 'keras45_01_x_train.npy', arr=x_train)
# np.save(np_path + 'keras45_01_x_train.npy', arr=xy_train[0][0])
np.save(np_path + 'keras45_01_x_train.npy', arr=y_train) #xy_train[0][1]
np.save(np_path + 'keras45_01_x_test.npy', arr=x_test) #xy_test[0][0]
np.save(np_path + 'keras45_01_y_test.npy', arr=y_test) #xy_test[0][1]
